...
const MAPBOX_ACCESS_TOKEN =
  "pk.eyJ1IjoidGhvbWFzYnVybGVzb24iLCJhIjoiY2phNWtmYzRwM2I3YTJ3cG9wcW1pODRjcSJ9.FSg2GyJtTaQRtLY6Ddx6rA";
 ...
 */
export const TILE_MAP_PROVIDERS = new InjectionToken<MapProviderFactory>(
  "tilemap.map.providers"
);
